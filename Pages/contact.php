            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-10 col-lg-8">
                        <h2 class="display-5 mb-4 mb-md-5 mb-xl-8">
                            Get in Touch!
                            Have a question or need help? We're here for you. Reach out to us, and we'll respond as
                            quickly as possible!
                        </h2>
                    </div>
                </div>
                            ...
                            <div class="col-12 col-xl-11">
                                <div class="mb-4 mb-md-5">
                                    ...
                                    <div>
                                        ...
                                        <address class="m-0 text-secondary">No.120/5, Vidya Mawatha, Colombo 07.
                                        </address>
                                    </div>
                                </div>
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0">
                                                    <a class="link-secondary text-decoration-none"
                                                        href="tel:+15057922430">(+94) 117-321-000</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <p class="text-secondary mb-0">9am - 4pm</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
